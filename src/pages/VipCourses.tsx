...
import { Crown, AlertTriangle, Lock, FileText, BookOpen } from 'lucide-react';
                    ...
                    <div className="space-y-6">
                      {sampleChapters.map((chapter) => (
                        <div key={chapter.id} className="space-y-4">
                          <h4 className="font-medium text-lg">Chương {chapter.id}: {chapter.title}</h4>
                ...
                <div className="bg-white dark:bg-gray-800 rounded-lg border shadow-sm p-6 sticky top-24">
                  ...
                  <div className="mb-6">
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <div>
                        <span className="text-xl font-bold text-yellow-600 dark:text-yellow-500">599.000đ</span>
                        <span className="text-sm text-muted-foreground line-through ml-2">999.000đ</span>
                      </div>
                    </div>
                    <div className="text-sm text-muted-foreground text-right">
                      Tiết kiệm 40% khi đăng ký ngay hôm nay
                    </div>
                  </div>
                  
                  <Separator className="my-6" />
                  
                  <Button className="w-full bg-yellow-600 hover:bg-yellow-700 mb-3" size="lg">
                    Đăng ký ngay
                  </Button>
